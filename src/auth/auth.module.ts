...
@Module({
  imports: [
    JwtModule.registerAsync({
      // O "registerAsync" é um método estático que permite registrar o módulo de forma assíncrona.
      global: true,
      useFactory: async (configService: ConfigService) => ({
        // O "useFactory" é uma função que retorna os parâmetros de config para o módulo JWT
